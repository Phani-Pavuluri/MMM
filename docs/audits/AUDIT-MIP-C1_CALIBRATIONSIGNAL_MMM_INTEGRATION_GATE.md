...
| MIP-C2 train-boundary wiring | [AUDIT-MIP-C2](AUDIT-MIP-C2_CALIBRATIONSIGNAL_TRAIN_BOUNDARY_WIRING.md) — optional file ingestion at `mmm train` / extension_runner |
| MIP-C3 GeoX/CLS adapter | [AUDIT-MIP-C3](AUDIT-MIP-C3_GEOX_CLS_SIGNAL_ADAPTER_GATE.md) — export → C2 JSON shape (no live API) |
