...
| INV-H4D sparse/τ stability pilot | [06_investigations/INV-H4D_SPARSE_TAU_AND_RECOVERY_STABILITY.md](06_investigations/INV-H4D_SPARSE_TAU_AND_RECOVERY_STABILITY.md); [H4D JSON](05_validation/archives/BAYES_H4D_SPARSE_TAU_STABILITY_20260601.json) — multi-seed + τ grid, no prod promotion |
