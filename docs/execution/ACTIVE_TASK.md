...
- Approval SHA: `null`
- Blockers: `tier1-batch-runner-missing`
- Live resolution condition: `Authorize a successor owning a deterministic Tier-1 batch runner (mmm/validation/synthetic/tier1_batch_runner.py + focused test) with a working Python 3.11/Docker environment, or rescope to report-only synthesis of existing tier-0 evidence with N<100 explicitly stated.`
