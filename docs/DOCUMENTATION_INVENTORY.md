...
| `docs/05_validation/bayes_h5_model_spec_improvement_adr.md` | `05_validation/bayes_h5_model_spec_improvement_adr.md` | canonical | Bayes-H5 sandbox model-spec ADR (H5a–H5n complete; H5o+ second real panel next) |
