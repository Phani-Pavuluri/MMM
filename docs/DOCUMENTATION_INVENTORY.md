...
| `docs/05_validation/MMM_MIP_HANDOFF_V1_POST_COMPATIBILITY_GAP_SELECTION_AUDIT_001_REPORT.md` | `05_validation/MMM_MIP_HANDOFF_V1_POST_COMPATIBILITY_GAP_SELECTION_AUDIT_001_REPORT.md` | canonical | Evidence-only R11/R12 dependency audit selecting supported-range evidence as the next narrow MMM prerequisite |
| `docs/05_validation/archives/MMM_MIP_HANDOFF_V1_POST_COMPATIBILITY_GAP_SELECTION_AUDIT_001_summary.json` | `05_validation/archives/MMM_MIP_HANDOFF_V1_POST_COMPATIBILITY_GAP_SELECTION_AUDIT_001_summary.json` | canonical | Deterministic post-compatibility R11/R12 selection summary; no simulation, surface, consumer, or freeze authorization |
| `docs/05_validation/mmm_supported_range_evidence_contract.md` | `05_validation/mmm_supported_range_evidence_contract.md` | canonical | MMM-owned typed supported-range evidence, scope, restriction, extrapolation, and additive linkage boundary |
| `tests/contracts/test_mmm_supported_range_evidence.py` | (tests) | canonical | Supported-range public contract, fixture, safety, and manifest/export linkage regressions |
